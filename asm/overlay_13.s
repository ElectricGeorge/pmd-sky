...
GetPersonality: ; 0x0238BDA8
	stmdb sp!, {r3, lr}
	ldr r0, _0238BDEC ; =OVERLAY13_UNKNOWN_POINTER__NA_238CEA0
	mov ip, #0
	ldr lr, [r0]
	mov r0, ip
	mov r3, ip
_0238BDC0:
	...
	ldmia sp!, {r3, pc}
	.align 2, 0
_0238BDEC: .word OVERLAY13_UNKNOWN_POINTER__NA_238CEA0
...
WaitForNextStep: ; 0x0238BE4C
	ldr r1, _0238BE68 ; =OVERLAY13_UNKNOWN_POINTER__NA_238CEA0
	mov r3, #0x3a
	ldr r2, [r1]
	str r3, [r2, #0x20]
	ldr r1, [r1]
	...
	bx lr
	.align 2, 0
_0238BE68: .word OVERLAY13_UNKNOWN_POINTER__NA_238CEA0
